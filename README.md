...
2. https://github.com/username/ac-heatmap-img/new/main?filename=config.json&value=%7B%22atcoder_id%22%3A%22your_atcoder_id%22%7D に AtCoder のユーザー名を入力しコミットします。(username は自分の GitHub ユーザー名に変更してください)
